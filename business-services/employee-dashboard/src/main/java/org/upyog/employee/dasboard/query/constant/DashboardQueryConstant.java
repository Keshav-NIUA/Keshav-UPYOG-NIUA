...
public class DashboardQueryConstant {
	...
	public static StringBuilder OBPAS_DASHBOARD_QUERY_ = new StringBuilder(
			"SELECT \n"
					+ "    COUNT(DISTINCT bp.applicationno) AS Total_Applications_Received,\n"
					+ "    COUNT(DISTINCT CASE\n"
					+ "        WHEN bp.status = 'APPROVED' THEN bp.applicationno\n"
					+ "    END) AS Total_Applications_Approved,\n"
					+ "    COUNT(DISTINCT bp.applicationno)\n"
					+ "    - COUNT(DISTINCT CASE\n"
					+ "        WHEN bp.status = 'APPROVED' THEN bp.applicationno\n"
					+ "      END) AS Total_Applications_Pending,\n"
					+ "    COALESCE(MAX(amt.total_amount), 0) AS Total_Amount\n"
					+ "FROM eg_bpa_buildingplan bp\n"
					+ "LEFT JOIN (\n"
					+ "    SELECT b.tenantid, SUM(o.amountpaid) AS total_amount\n"
					+ "    FROM egcl_bill b\n"
					...
					+ "    )\n"
					+ "    GROUP BY b.tenantid\n"
					+ ") amt ON amt.tenantid = bp.tenantid\n"
					+ "WHERE bp.businessservice = 'BPA'\n"
					+ "  AND bp.tenantid = ?"
	);
	...
	public static StringBuilder EWASTE_DASHBOARD_QUERY_ = new StringBuilder(
			"SELECT \n"
					...
					+ "             FROM eg_wf_processinstance_v2 pi2\n"
					+ "             WHERE pi2.businessid = pi.businessid\n"
					+ "               AND pi2.action = 'COMPLETEREQUEST'\n"
					+ "         ) THEN pi.businessid\n"
					+ "    END) AS Total_Applications_Pending,\n"
					+ "    COALESCE(\n"
					+ "        (SELECT SUM(o.amountpaid)\n"
	...
	public static StringBuilder WATER_DASHBOARD_QUERY_ = new StringBuilder(
			"SELECT \n"
					...
					+ "             FROM eg_wf_processinstance_v2 pi2\n"
					+ "             WHERE pi2.businessid = pi.businessid\n"
					+ "               AND pi2.action = 'ACTIVATE_CONNECTION'\n"
					+ "         ) THEN pi.businessid\n"
					+ "    END) AS Total_Applications_Pending,\n"
					+ "    COALESCE(\n"
					+ "        (SELECT SUM(o.amountpaid)\n"
	...
	public static StringBuilder WT_DASHBOARD_QUERY_ = new StringBuilder(
			"SELECT \n"
					...
					+ "         FROM egcl_bill b\n"
					+ "         JOIN egcl_paymentdetail o ON o.billid = b.id\n"
					+ "         WHERE o.businessservice IN ('request-service.water_tanker')\n"
					+ "        ), 0) AS Total_Amount\n"
					+ "FROM \n"
					+ "    eg_wf_processinstance_v2 pi\n"
					+ "WHERE \n"
					+ "    pi.businessservice = 'watertanker'\n"
					+ "    AND pi.tenantid = ?"
	);
	...
	public static StringBuilder TP_DASHBOARD_QUERY_ = new StringBuilder(
			"SELECT \n"
					...
					+ "         FROM egcl_bill b\n"
					+ "         JOIN egcl_paymentdetail o ON o.billid = b.id\n"
					+ "         WHERE o.businessservice IN ('request-service.tree_pruning')\n"
					+ "        ), 0) AS Total_Amount\n"
					+ "FROM \n"
					+ "    eg_wf_processinstance_v2 pi\n"
					+ "WHERE \n"
					+ "    pi.businessservice = 'treePruning'\n"
					+ "    AND pi.tenantid = ?"
	);
	...
	public static StringBuilder MT_DASHBOARD_QUERY_ = new StringBuilder(
			"SELECT \n"
					...
					+ "         FROM egcl_bill b\n"
					+ "         JOIN egcl_paymentdetail o ON o.billid = b.id\n"
					+ "         WHERE o.businessservice IN ('request-service.mobile_toilet')\n"
					+ "        ), 0) AS Total_Amount\n"
					+ "FROM \n"
					+ "    eg_wf_processinstance_v2 pi\n"
					+ "WHERE \n"
					+ "    pi.businessservice = 'mobileToilet'\n"
					+ "    AND pi.tenantid = ?"
	);
	...
	public static StringBuilder CND_DASHBOARD_QUERY_ = new StringBuilder(
			"SELECT \n"
					...
					+ "         FROM egcl_bill b\n"
					+ "         JOIN egcl_paymentdetail o ON o.billid = b.id\n"
					+ "         WHERE o.businessservice IN ('cnd-service')\n"
					+ "        ), 0) AS Total_Amount\n"
					+ "FROM \n"
					+ "    eg_wf_processinstance_v2 pi\n"
					+ "WHERE \n"
					+ "    pi.businessservice = 'cnd'\n"
					+ "    AND pi.tenantid = ?"
	);
