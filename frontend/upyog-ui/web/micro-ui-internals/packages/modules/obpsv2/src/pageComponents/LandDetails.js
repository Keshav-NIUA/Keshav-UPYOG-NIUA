...
const LandDetails = ({ t, config, onSelect, formData }) => {
  ...
  const constructionTypeOptions = [
    { code: "NEW_CONSTRUCTION", name: "New Construction" },
    { code: "ADDITION_ALTERATION", name: "Addition Alteration" },
    { code: "REVISION", name: "Revision" },
    { code: "CHANGE_OF_USE", name: "Change of Use" },
    { code: "DEMOLITION_PERMISSION", name: "Demolition Permission" }
  ];
  ...
  const todZoneOptions = [
    { code: "INTENSE", name: "Intense" },
    { code: "TRANSITION_ZONE", name: "Transition Zone" }
  ];

  // RTP Category Options
  const rtpCategoryOptions = [
    { code: "ENGINEER", name: "Engineer" },
    { code: "ARCHITECT", name: "Architect" },
    { code: "GENERAL_AGENCY", name: "General Agency" }
  ];
  ...
  const occupancyTypeOptions = [
    ...
    { code: "TYPE3", name: "Type 3" },
    { code: "TYPE4", name: "Type 4" },
    { code: "TYPE5", name: "Type 5" }
  ];

  // Registered Technical Person Options
  const rtpOptions = [
    { code: "RTP001", name: "Ranjit +91 9988888890, ranjit@gmail.com" },
    { code: "RTP002", name: "Ajeet +91 7855552377, ajeet@gmail.com" },
    { code: "RTP003", name: "Ani +91 9845454245, ani@gmail.com" },
    { code: "RTP004", name: "Khalid +91 9845858533, khalid@gmail.com" },
    { code: "RTP005", name: "Kunal +91 8755258542, kunal@gmail.com" },
    { code: "RTP006", name: "Anil +91 9907926555, anil@gmail.com" }
  ];
        ...
        <div>
          ...
          {todBenefits?.code === "YES" && (
            ...
            <RadioButtons
                t={t}
                options={[
                { code: "WITH_TDR", name: "With TDR (if yes uploading TDR is mandatory)" },
                { code: "WITHOUT_TDR", name: "Without TDR" }
                ]}
                optionsKey="name"
                name="todWithTdr"
                value={todWithTdr}
