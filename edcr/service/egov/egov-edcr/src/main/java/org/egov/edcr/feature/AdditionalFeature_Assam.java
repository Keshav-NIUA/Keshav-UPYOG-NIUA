...
public class AdditionalFeature_Assam extends FeatureProcess {
    ...
    private void validateHeightOfBuilding(Plan pl, HashMap<String, String> errors, BigDecimal roadWidth,
        ...
        for (Block block : pl.getBlocks()) {
                    ...
                    || block.getBuilding().getFloors().size() >= additionalFeatureBuildingHeightB.intValue())
            {
                ...
                BigDecimal maxPermittedHeight = validateMaxPermittedHeight(roadWidth, setBacks, additionalFeatureBuildingHeightCappedPermitted, additionalFeatureBuildingHeightMaxPermitted);
     ...
     *
     * @param roadWidth Width of the road
     * @param setBacks List of setbacks for the building
     ...
     */
    private BigDecimal validateMaxPermittedHeight(BigDecimal roadWidth, List<SetBack> setBacks, BigDecimal additionalFeatureBuildingHeightCappedPermitted, BigDecimal additionalFeatureBuildingHeightMaxPermitted) {
